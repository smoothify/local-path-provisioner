...
[Local Path Provisioner](https://github.com/smoothify/local-path-provisioner) provides a way for the Kubernetes users to
...
This chart bootstraps a [Local Path Provisioner](https://github.com/smoothify/local-path-provisioner) deployment on a
...
| ----------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `image.repository`                  | Local Path Provisioner image name                                               | `smoothify/local-path-provisioner`                                                    |
